...
export default new VueRouter({
    routes: [
        ...
        { path: '/user/edit/:id', name: 'user.edit', component: require('./components/modules/user/EditForm.vue').default, props:true},
        ...
        { path: '/meet', name: 'meet', component: require('./components/modules/meet/Index.vue').default},
        { path: '/meeting', name: 'meeting', component: require('./components/modules/meet/Meeting.vue').default},
