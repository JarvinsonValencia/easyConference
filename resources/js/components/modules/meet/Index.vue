                    ...
                    <div class="card-tools">
                        ...
                        <div>
                            <b-button
                                ...
                                @click="openModal('modal-form-meet')"
                            >
                            ...
                            >
                                <Form
                                    :user="user"
                                    @closeModal="closeModal('modal-form-meet')"
                                ></Form>
                            </b-modal>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        getListMeetings(role_id, client_id) {
            axios
                .get(
                    `/administration/meet/getListMeetings/${role_id}/${client_id}`
                )
                .then((res) => {
        ...
        deleteMeet(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .delete(`/administration/meet/deleteMeet/${id}`)
                        .then(() => {
                            this.getListMeetings(
                                this.user.role_id,
                                this.user.client_id
